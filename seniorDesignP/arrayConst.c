...
int createArray(arrayConst ** arrayPointer, char *fileLoc){
    ...
    {{x1,y1+0.0,z1},{x1+.7,y1+0.0,z1},{x2,y2+0.0,z2},{x2+.6,y2+0.0,z2},{x3,y3+0.0,z3},{x3+.7,y3+0.0,z3}},

    {{x1,y1+0.5,z1},{x1+.7,y1+0.5,z1},{x2,y2+0.5,z2},{x2+.6,y2+0.5,z2},{x3,y3+0.5,z3},{x3+.7,y3+0.5,z3}},

    {{x1,y1+1.0,z1},{x1+.7,y1+1.0,z1},{x2,y2+1.0,z2},{x2+.6,y2+1.0,z2},{x3,y3+1.0,z3},{x3+.7,y3+1.0,z3}},

    {{x1,y1+1.5,z1},{x1+.7,y1+1.5,z1},{x2,y2+1.5,z2},{x2+.6,y2+1.5,z2},{x3,y3+1.5,z3},{x3+.7,y3+1.5,z3}},

    {{x1,y1+2.0,z1},{x1+.7,y1+2.0,z1},{x2,y2+2.0,z2},{x2+.6,y2+2.0,z2},{x3,y3+2.0,z3},{x3+.7,y3+2.0,z3}},

    {{x1,y1+2.5,z1},{x1+.7,y1+2.5,z1},{x2,y2+2.5,z2},{x2+.6,y2+2.5,z2},{x3,y3+2.5,z3},{x3+.7,y3+2.5,z3}},

    {{x1,y1+3.0,z1},{x1+.7,y1+3.0,z1},{x2,y2+3.0,z2},{x2+.6,y2+3.0,z2},{x3,y3+3.0,z3},{x3+.7,y3+3.0,z3}},

    {{x1,y1+3.5,z1},{x1+.7,y1+3.5,z1},{x2,y2+3.5,z2},{x2+.6,y2+3.5,z2},{x3,y3+3.5,z3},{x3+.7,y3+3.5,z3}},

    {{x1,y1+4.0,z1},{x1+.7,y1+4.0,z1},{x2,y2+4.0,z2},{x2+.6,y2+4.0,z2},{x3,y3+4.0,z3},{x3+.7,y3+4.0,z3}},

    {{x1,y1+4.5,z1},{x1+.7,y1+4.5,z1},{x2,y2+4.5,z2},{x2+.6,y2+4.5,z2},{x3,y3+4.5,z3},{x3+.7,y3+4.5,z3}}
